        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-[clamp(1rem,2vw,2.5rem)] items-start">
          ...
          >
            ...
            <div className="p-8 bg-white rounded-[2rem] border border-slate-700 shadow-sm">
              <p className="text-slate-600 leading-relaxed text-[clamp(1rem,1.1vw,1.2rem)] italic">
                ...
                <span className="text-[#33cdcc] font-semibold">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            >
              ...
              and CI/CD automation, ensuring production-ready engineering
              workflows.
            </motion.p>
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  {
                    logo: campusLogo,
                    title: "SLTC Research University",
                    date: "2021 – 2025",
                    desc: "BSc (Honours) in Cloud Computing. Mastered AWS, DevOps, and Full-Stack Engineering.",
                  },
                  {
                    logo: schoolLogo,
                    title: "St. Sylvester’s College",
                    date: "2010 – 2018",
                    desc: "Solidified primary & secondary foundations with a focus on problem-solving and leadership.",
                  },
                ].map((edu, i) => (
                  <div
                    key={i}
                    className="group bg-white p-8 rounded-[2rem] border border-[#33cdcc] hover:border-[#33cdcc]/40 hover:shadow-xl transition-all duration-500"
                  >
                    <div className="flex justify-between items-center mb-6">
                      ...
                      />
                      <span className="text-[10px] font-black bg-slate-50 px-3 py-1 rounded-full text-slate-400 uppercase tracking-tighter">
                        {edu.date}
                      </span>
                    </div>
                    <h3 className="text-lg font-bold mb-2 group-hover:text-[#33cdcc] transition-colors">
                      {edu.title}
                    </h3>
              ...
              <div className="relative group bg-slate-900 text-white p-8 md:p-12 rounded-[2.5rem] overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 flex flex-col xl:flex-row gap-10">
                  <div className="flex-1">
                    <span className="inline-block px-3 py-1 rounded-full bg-[#33cdcc]/20 text-[#33cdcc] text-[10px] font-bold uppercase mb-4 tracking-wider">
                      Internship
                    </span>
                    <h3 className="text-2xl md:text-3xl font-bold mb-2 italic">
                    ...
                    <p className="text-slate-300 text-sm md:text-base leading-relaxed max-w-xl">
                      Developed high-performance React/Laravel applications. I
                      collaborated across teams to translate complex functional
                      requirements into production-ready technical solutions.
                    </p>
                  </div>
                </div>
              </div>
